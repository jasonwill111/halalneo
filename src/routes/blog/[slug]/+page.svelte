	...
	{#if data.item}
		...
		<article class="space-y-8">
				...
				<section class="space-y-4 border-t border-border pt-8">
					...
					<div class="grid gap-3 sm:grid-cols-3">
						{#each data.related as related}
							<a href="/blog/{related.slug}" class="group block rounded-xl border border-border bg-card p-4 transition-all hover:shadow-md">
			...
			<div class="grid gap-4 sm:grid-cols-3">
				<a href="/products" class="group block rounded-xl border border-border bg-card p-5 transition-all hover:shadow-md">
					<div class="mb-2">
				...
				<a href="/suppliers" class="group block rounded-xl border border-border bg-card p-5 transition-all hover:shadow-md">
					<div class="mb-2">
				...
				<a href="/knowledge-base" class="group block rounded-xl border border-border bg-card p-5 transition-all hover:shadow-md">
					<div class="mb-2">
