		...
		<div class="grid gap-6 lg:grid-cols-[1fr_320px]">
			<main class="space-y-4 sm:space-y-6">
								...
								<ul class="space-y-1.5">
									{#each tocItems as tocItem (tocItem.id)}
										<li>
											<a
												href={'#' + tocItem.id}
												class="block text-xs text-muted-foreground transition-colors hover:text-foreground"
				...
				<div class="mt-8 border-t border-border pt-6">
					<h2 class="mb-4 text-base font-semibold tracking-tight sm:text-lg">
	...
	{:else}
		<div class="flex min-h-[50vh] items-center justify-center">
			<div class="space-y-4 text-center">
				<p class="text-sm text-muted-foreground">Blog post coming soon.</p>
