...
<section class="space-y-4 sm:space-y-6">
	...
	<Card class="p-3 sm:p-6">
		...
		<p class="text-sm leading-relaxed text-muted-foreground">
			...
			catalogs, and comprehensive trade intelligence 鈥?all in one platform. We help buyers find
		...
		<Card class="p-3 sm:p-4">
			...
			<CardContent>
				<p class="text-sm text-muted-foreground">
					Every supplier on the platform carries independently issued halal certification 鈥?with
		...
		<Card class="p-3 sm:p-4">
			...
			<CardContent>
				<p class="text-sm text-muted-foreground">
					...
					due diligence and country market entry 鈥攚ritten for real B2B buyers.
				</p>
			</CardContent>
		</Card>
		<Card class="p-3 sm:p-4">
			...
			<CardContent>
				<p class="text-sm text-muted-foreground">
					...
					buyers actually import into 鈥攆rom Southeast Asia to the Gulf.
				</p>
			</CardContent>
		</Card>
	</div>
		...
		<div class="grid grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3">
			<Card class="p-3 sm:p-4">
				<CardHeader class="gap-3">
					...
					<CardTitle class="text-sm sm:text-base">01 路 Source</CardTitle>
					<CardDescription
			...
			<Card class="p-3 sm:p-4">
				<CardHeader class="gap-3">
					...
					<CardTitle class="text-sm sm:text-base">02 路 Verify</CardTitle>
					<CardDescription
						>Check certification scope, standard and expiry before you commit 鈥攏o chasing down
			...
			<Card class="p-3 sm:p-4">
				<CardHeader class="gap-3">
					...
					<CardTitle class="text-sm sm:text-base">03 路 Ship</CardTitle>
					<CardDescription
	...
	<div class="rounded-xl bg-muted/40 p-3 sm:p-10">
		<div class="grid gap-8 sm:grid-cols-2 sm:items-center">
			<div class="space-y-3">
				...
				<p class="text-xs text-muted-foreground sm:text-sm">
					Researched knowledge base, trade tools, and market intelligence 鈥?built for halal B2B
	...
	<Card class="p-3 sm:p-6">
		...
		<p class="text-sm leading-relaxed text-muted-foreground">
			...
			halal certifying bodies 鈥?JAKIM, MUI/LPPOM, ESMA, SFDA, IFANCA, and others. We cross-reference
	...
	<div class="space-y-4 sm:space-y-6">
		...
		<div class="flex flex-wrap gap-2">
			{#each data.certifiers ?? [] as body (body.id)}
				<Badge variant="outline">{body.name} 路 {body.standard}</Badge>
			{/each}
		</div>
	</div>
