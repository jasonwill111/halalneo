				...
				>
					...
					>
						...
						{#if product.certStatus === 'certified'}
							<Badge
								class="absolute start-1.5 top-1.5 bg-success/10 text-success hover:bg-success/20"
							>
								Halal
							</Badge>
						{:else if product.certStatus === 'pending'}
							<Badge class="absolute start-1.5 top-1.5 bg-warn/10 text-warn hover:bg-warn/20">
								Pending
							</Badge>
						{/if}
					</div>
