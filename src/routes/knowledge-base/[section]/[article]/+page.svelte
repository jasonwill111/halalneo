			...
			<aside class="hidden w-56 shrink-0 lg:block">
				<div class="sticky top-20 space-y-6">
					...
					<div class="rounded-xl border border-primary/20 bg-primary/5 p-4">
						...
						<Button href={localizeHref('/tools/ingredient-checker')} size="sm" class="w-full">Ingredient Checker</Button>
					</div>
				</div>
			</aside>
			...
			<article class="min-w-0 flex-1 space-y-8">
				...
				{#if related.length > 0}
					<section class="space-y-4 border-t border-border pt-8">
						...
						<div class="grid gap-3 sm:grid-cols-3">
							{#each related as rel}
								<a href={localizeHref(`/knowledge-base/${rel.sectionSlug}/${rel.slug}`)} class="group block rounded-xl bg-card shadow-sm p-4 transition-all hover:shadow-md">
				...
				<div class="mt-8 border-t border-border pt-6">
					...
					<div class="grid gap-4 sm:grid-cols-3">
						<a href={localizeHref('/certifying-bodies')} class="group block rounded-xl border border-border bg-card p-5 transition-all hover:shadow-md">
							<div class="mb-2">
						...
						<a href={localizeHref('/market-guides')} class="group block rounded-xl border border-border bg-card p-5 transition-all hover:shadow-md">
							<div class="mb-2">
						...
						<a href={localizeHref('/tools/ingredient-checker')} class="group block rounded-xl border border-border bg-card p-5 transition-all hover:shadow-md">
							<div class="mb-2">
