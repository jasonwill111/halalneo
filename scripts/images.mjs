...
function generateR2Key(id, ext = 'webp') {
	return `media/${getDateKey()}/${id}.${ext}`;
}
...
const IMAGES = {
	...
	products: [
		{
			id: 'rendang',
			src: 'https://loremflickr.com/800/800/spice,paste,indonesian',
			w: 800,
			h: 800
		},
		...
		{
			id: 'capsule',
			src: 'https://loremflickr.com/800/800/supplement,vitamin,capsule',
			w: 800,
			h: 800
		},
		{
			id: 'protein',
			src: 'https://loremflickr.com/800/800/protein,powder,nutrition',
			w: 800,
			h: 800
		}
	],
	...
	categories: [
		{
			...
			src: 'https://picsum.photos/seed/catfood1/400/400',
			w: 400,
			h: 400
		},
		...
		{ id: 'cat-dairy-eggs', src: 'https://picsum.photos/seed/catdairy3/400/400', w: 400, h: 400 },
		{
			...
			src: 'https://picsum.photos/seed/catcandy4/400/400',
			w: 400,
			h: 400
		},
...
switch (cmd) {
	...
	case 'all':
		...
		break;
	default:
		console.log('Usage: node scripts/images.mjs [download|upload|all|urls] [--apply]');
}
