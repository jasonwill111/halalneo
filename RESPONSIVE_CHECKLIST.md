...
```svelte
<!-- 确认 touch targets -->
<a href={body.website} target="_blank" rel="noopener" class="relative z-10 rounded-md p-1 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground" aria-label="Visit {body.name} website">
