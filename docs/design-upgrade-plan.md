...
| 批次 | 内容 | 文件面 | 验证 |
|---|---|---|---|
| B1 | §1.1 token 替换（teal/gold 进 layout.css + DESIGN.md，purple/rose 移除）+ 使用点全量替换 | layout.css、DESIGN.md、stat-tile、region.ts、tile-colors.ts、首页 | 红线 grep 0；对比度脚本；svelte-check |
